...
Hands-on experiments, each answering one measurable question about the
reBot Arm B601-RS control system. See [`docs/ROADMAP.md`](../docs/ROADMAP.md)
for the full sequence and what each lab teaches.

| Lab | Question | Hardware needed |
|---|---|---|
